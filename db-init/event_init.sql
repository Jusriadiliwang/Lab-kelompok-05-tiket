...
INSERT INTO events (name, venue, event_date, description, banner_url, status) VALUES
    ...
    ('Slipknot Download Festival',
     ...
     'https://cdn.example.com/banners/slipknot-download.jpg',
     'upcoming'),
